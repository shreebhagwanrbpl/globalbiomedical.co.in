...
export async function fetchHomeData() {
  return fetchDocCached("websites/globalbiomedicalcoin/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/globalbiomedicalcoin/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/globalbiomedicalcoin/pages/services");
}
